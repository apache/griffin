...
case class AccuracyAnalyzer(expr: Expr, sourceName: String, targetName: String) extends BasicAnalyzer {
  ...
  val sourceSelectionExprs = {
    ...
    expr.preOrderTraverseDepthFirst(Seq[Expr]())(seq, combSelectionExprs)
  }
